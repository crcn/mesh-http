...
var HTTPDatabase = function(options) {
  ...
  this.path    = function(operation) {
    ...
    return {
      ...
      "update" : "/" + operation.collection + "/" + operation.data[this.idProperty],
      "load"   : operation.multi ? "/" + operation.collection : "/" + operation.collection + "/" + operation.data[this.idProperty],
      "remove" : "/" + operation.collection + "/" + operation.data[this.idProperty]
    }[operation.name];
  };
